...
const GameCard = () => {
  ...
  const bingoScoreTotal = gameCardInfo.beatemupBingo ? Object.keys(gameCardInfo.beatemupBingo).length : null;
  const bingoScore = gameCardInfo.beatemupBingo && Object.values(gameCardInfo.beatemupBingo).filter((value) => value === true).length;
  ...
  return (
    <div className="game-card">
      ...
      <ul className="game-card__detail">
        ...
        <li>
          <span className="game-card__parameter-name">Beat'em Up Bingo: </span><span>{bingoScore} of {bingoScoreTotal}
          ...
          {/* <span>info</span><Bingo beatemupBingo={beatemupBingo}/></span> */}
        </li>
        <li>

    ...
    <div className="bingo">
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.sunsetEnding
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.sleevelessJacket
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.bossWithGun
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.twowordTitle
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.throwingKnife
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.subwayStage
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.exproWrestler
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.kindnappedFemale
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.specialDrainsHealth
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.yellowRedHealthBar
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.powerSpeedBalance
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.elevatorScene
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.mansionStage
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.buildingSite
        )}
      ...
      <div
        className={toggleActiveClass(
          beatemupBingo && beatemupBingo.fatCharginMen
        )}
